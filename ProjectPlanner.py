...
def read_tasks(filename):
        ...
        for row in csv.reader(open(filename)):
            ...
            tasks[number]=Task(title,duration,prereq)
        return tasks
    ...
    while incomplete:
        for task_number in incomplete:
            ...
            if task.prerequisites.issubset(completed):
                ...
                for prereq_num in task.prerequisites:
                    prereq_end_day=start_days[prereq_num]+tasks[prereq_num].duration
